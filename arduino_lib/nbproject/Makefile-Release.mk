...
${OBJECTDIR}/CDC.o: CDC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CDC.o CDC.cpp

${OBJECTDIR}/HID.o: HID.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HID.o HID.cpp

${OBJECTDIR}/HardwareSerial.o: HardwareSerial.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HardwareSerial.o HardwareSerial.cpp

${OBJECTDIR}/HardwareSerial0.o: HardwareSerial0.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HardwareSerial0.o HardwareSerial0.cpp

${OBJECTDIR}/HardwareSerial1.o: HardwareSerial1.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HardwareSerial1.o HardwareSerial1.cpp

${OBJECTDIR}/HardwareSerial2.o: HardwareSerial2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HardwareSerial2.o HardwareSerial2.cpp

${OBJECTDIR}/HardwareSerial3.o: HardwareSerial3.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HardwareSerial3.o HardwareSerial3.cpp
...
${OBJECTDIR}/Print.o: Print.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Print.o Print.cpp

${OBJECTDIR}/Stream.o: Stream.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Stream.o Stream.cpp

${OBJECTDIR}/Tone.o: Tone.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tone.o Tone.cpp

${OBJECTDIR}/USBCore.o: USBCore.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/USBCore.o USBCore.cpp

${OBJECTDIR}/WInterrupts.o: WInterrupts.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WInterrupts.o WInterrupts.c

${OBJECTDIR}/WMath.o: WMath.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WMath.o WMath.cpp

${OBJECTDIR}/WString.o: WString.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WString.o WString.cpp

${OBJECTDIR}/abi.o: abi.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/abi.o abi.cpp

${OBJECTDIR}/hooks.o: hooks.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hooks.o hooks.c
...
${OBJECTDIR}/new.o: new.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/new.o new.cpp

${OBJECTDIR}/wiring.o: wiring.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiring.o wiring.c

${OBJECTDIR}/wiring_analog.o: wiring_analog.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiring_analog.o wiring_analog.c

${OBJECTDIR}/wiring_digital.o: wiring_digital.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiring_digital.o wiring_digital.c

${OBJECTDIR}/wiring_pulse.o: wiring_pulse.S 
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/wiring_pulse.o wiring_pulse.S

${OBJECTDIR}/wiring_pulse.o: wiring_pulse.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiring_pulse.o wiring_pulse.c

${OBJECTDIR}/wiring_shift.o: wiring_shift.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiring_shift.o wiring_shift.c
